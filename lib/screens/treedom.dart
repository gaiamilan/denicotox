...
class TreedomPage extends StatefulWidget {
  const TreedomPage({super.key});

  @override
  State<TreedomPage> createState() => _TreedomPageState();
}
...
class _TreedomPageState extends State<TreedomPage> {
  ...
  Future<void> _loadEvidenziatiIndices() async {
    ...
    final indicesStringList = prefs.getStringList('evidenziati_indices_treedom') ?? [];
